...
- [x] 1.1 Zainstalować `vitest` i `@vitest/coverage-v8` — 04c4027
- [x] 1.2 Dodać skrypty `test`, `test:unit`, `test:coverage`, `test:watch` — 04c4027
- [x] 1.3 Utworzyć `vitest.config.ts` — 04c4027

#### Ręczne

- [x] 1.4 Zweryfikować, że Playwright pozostaje niezależny — 04c4027

### Faza 2: Wyodrębnienie logiki weryfikacji

#### Automatyczne

- [x] 2.1 Utworzyć `src/lib/verify-exercise.ts` z czystymi funkcjami — 1e33b0c
- [x] 2.2 Zrefaktoryzować `src/pages/api/exercises/verify.ts` do użycia `verifyExercise` — 1e33b0c

#### Ręczne

- [x] 2.3 Potwierdzić brak regresji w E2E closed-exercises i sentence-transformation — 1e33b0c
...
- [x] 5.1 Uruchomić `npm run typecheck`, `npm run lint`, `npm run test:unit`, E2E — 77637f8

#### Ręczne

- [x] 5.2 Zaktualizować `context/foundation/test-plan.md` §6 cookbook — 77637f8
