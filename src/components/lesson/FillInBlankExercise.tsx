...
export default function FillInBlankExercise({ exercise, onCorrect, disabled = false, initialCorrectAnswer }: Props) {
  ...
  return (
    <div className="rounded-xl border border-white/10 bg-white/5 p-5">
      ...
      <input
        ...
        className="w-full rounded-lg border border-white/10 bg-white/5 px-4 py-3 text-sm text-white outline-none placeholder:text-slate-500 focus:border-blue-500 disabled:cursor-not-allowed disabled:opacity-50"
      />
